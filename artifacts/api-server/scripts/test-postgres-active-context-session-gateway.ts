...
assert.equal(
  process.env.ALLOW_DISPOSABLE_SESSION_GATEWAY_TEST,
  "true",
...
for (const [value, expectedUser] of [
  ...
  [sessionResolverUrl, "fas_session_resolver"],
  [rateLimitUrl, "fas_rate_limit_executor"],
  [lifecycleUrl, "fas_session_lifecycle_executor"],
  [repairUrl, "fas_session_repair_executor"],
