  ...
  return (
    <Dialog open={open} onOpenChange={o => !o && onClose()}>
      <DialogContent
        ...
        onPointerDownOutside={preventPipelineDialogOutsideDismiss}
        onFocusOutside={preventPipelineDialogOutsideDismiss}
        onEscapeKeyDown={preventPipelineDialogOutsideDismiss}
      >
