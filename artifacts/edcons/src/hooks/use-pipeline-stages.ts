...
export interface PipelineStage {
  ...
  completionTargetStageId?: number | null;
  completionTargetStageKey?: string | null;
  // Legacy aliases retained while every environment still stores the value
  // in `missing_docs_fulfilled_target_stage_id`.
