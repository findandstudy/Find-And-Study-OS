...
const purePublicWebChecks = [
  ...
  "test:public-web-draft-import-manifest",
  "test:public-web-import-adapter-approval",
  "test:public-web-draft-import-preview",
  "test:public-web-draft-preview-receipt",
  "test:public-web-publication-runtime-boundary",
  "test:public-web-draft-import-preflight",
  "test:public-web-draft-import-server-plan",
  "test:public-web-draft-import-job-contract",
